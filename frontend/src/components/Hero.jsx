      ...
      <div className="space-y-6">
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
            <Link
              to="/about"
              className="group relative inline-flex min-w-[230px] items-center overflow-hidden rounded-full border border-yellow-400/70 bg-zinc-900/40 px-12 py-3 text-base font-semibold uppercase tracking-widest text-white shadow-lg shadow-black/40"
            >
